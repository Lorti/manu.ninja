...
I have presented the current progress of this project at the [Stahlstadt.js] meetup in May. After that this year's great summer prevented me from writing about it. [The game already has about 500 lines of code at this stage][Corsair], which is why I have decided to start my first three-part blog post series:
