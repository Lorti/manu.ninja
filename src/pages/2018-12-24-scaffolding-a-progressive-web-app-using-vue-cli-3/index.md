...
The same is true for the project's `package.json` file. Whereas a project created with Vue CLI 2 had dozens of dependencies listed, our application only has five dependencies (this of course depends on what you've selected in the prompts):
